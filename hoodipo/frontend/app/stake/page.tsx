...
export default function StakePage() {
  ...
  // Placeholder: pretend total staked is 500,000 $IPO.
  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-2">Stake $IPO</h1>
        <p className="text-gray-400 mb-8">
          Locking $IPO boosts your IPO allocation on every SubscriptionVault (up to 3x).
        </p>
        ...
        <div className="card p-8 space-y-6">
          ...
          <div className="border-t border-chain-border pt-4 text-xs text-gray-500">
            ...
            $IPO buybacks. Stake &amp; earn from both allocation boost and long-term
            protocol accrual.
          </div>

          <div className="flex gap-3">
            <button className="btn-primary flex-1 py-3">Stake</button>
            <button className="btn-outline flex-1 py-3">Buy $IPO on Pons ↗</button>
          </div>
        </div>
      </main>
    </>
