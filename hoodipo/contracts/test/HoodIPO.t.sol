...
contract HoodIPOTest is Test {
    ...
    function setUp() public {
        ...
        ipoToken = new MockERC20("HoodIPO", "IPO", 18);
        ...
        booster = new AllocationBooster(address(ipoToken));
        ...
        ipoToken.mint(alice, 100_000e18);
        ipoToken.mint(bob, 100_000e18);
    }
    ...
    function test_subscribe_addsDepositAndWeight() public {
        ...
        // Without staking $IPO, boost = 1x → weight == amount
    ...
    function test_subscribe_appliesBoost() public {
        ...
        // Alice stakes 10k $IPO, becoming the only staker → boost approaches MAX
        vm.startPrank(alice);
        ipoToken.approve(address(booster), 10_000e18);
    ...
    function test_booster_stakeLockAndUnstake() public {
        vm.startPrank(alice);
        ipoToken.approve(address(booster), 5_000e18);
    ...
    function test_boosterCurve_capsAt3x() public {
        vm.startPrank(alice);
        ipoToken.approve(address(booster), 100_000e18);
