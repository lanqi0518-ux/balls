...
/// @notice Users lock $RPO to receive an allocation boost (1x – 3x) on any
...
contract AllocationBooster is ReentrancyGuard {
    ...
    IERC20 public immutable rpoToken;
    ...
    function stake(uint256 amount) external nonReentrant {
        ...
        rpoToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function unstake(uint256 amount) external nonReentrant {
        ...
        s.amount -= amount;
        totalStaked -= amount;
        rpoToken.safeTransfer(msg.sender, amount);
