...
const MENUS: Menu[] = [
  {
    ...
    cta: {
      label: "Launch app →",
      href: "/app",
      hint: "Connect a wallet on the target chain.",
    },
  },
  {
    label: "Learn",
    items: [
      { label: "Whitepaper", href: "/whitepaper", hint: "Technical draft" },
      { label: "Economics", href: "/economics", hint: "Deal flow · boost · flywheel" },
      { label: "Roadmap", href: "/roadmap", hint: "Phases toward mainnet" },
      { label: "Tokenomics", href: "/tokenomics", hint: "Supply, distribution, flywheel" },
      { label: "Governance", href: "/governance", hint: "Design (pre-launch)" },
      { label: "Ecosystem", href: "/ecosystem", hint: "Planned integrations" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Changelog", href: "/changelog", hint: "Repo timeline" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Audits", href: "/audits", hint: "Not yet audited" },
      { label: "Bug bounty", href: "/bounty", hint: "Launches with audits" },
  ...
  },
  {
    label: "Company",
    items: [
      { label: "About", href: "/about", hint: "Mission" },
    ],
  },
];
